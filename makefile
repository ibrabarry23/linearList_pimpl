main: build/List_dl.o build/princ.o
	g++ build/List_dl.o build/princ.o -o build/main
...
build/List_dl.o: src/List_dl.cpp include/list.hpp
	g++ -c src/List_dl.cpp -o build/List_dl.o -std=c++14 -Wall -Iinclude
